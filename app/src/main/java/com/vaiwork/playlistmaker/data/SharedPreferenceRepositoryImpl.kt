...
class SharedPreferenceRepositoryImpl(
    ...
    override fun addTrack(
        ...
        dbClient.putString(
            ...
            sharedPreferenceKey,
            Gson().toJson(tracks, object : TypeToken<List<Track>>() {}.type)
        )
    }
    ...
    override fun getTracks(
        ...
        val dtoTracks =
            dbClient.getTracks(sharedPreferenceName, sharedPreferenceMode, sharedPreferenceKey)
